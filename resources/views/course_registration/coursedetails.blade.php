        ...
        <div class="content">
          ...
          <div class="small-container">
            ...
            <div class="row">
                ...
                <div class="col-2">
                  <img src="{{asset('uploads/' . $cpic)}}"  height="550px" width="860px" > 
                </div>
        
                <div class="right">
                  <p>Course Id :      {{$cid}}</p>
                    <p>Course Name :      {{$cname}}</p>
                    <p> Course Price :    {{$cprice}}</p>
                   
                   <p> Course Start Time: {{$cstart}}</p>
                    <p> Course End Time:  {{$cend}}</p>
                   
                    <h3>Course Deteils</h3></br>
                    <p> Course Description : {{$cdescription}}</p>
        
                    <a href="{{route('course_registration.register', $cid)}}"> Register This Course </a>
                </div>
            </div>
            </div>
