    ...
    <section id="home">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="slidepic" src="/images/aiubpic1.jpg" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
          <img class="slidepic" src="/images/aiubpic2.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img class="slidepic" src="/images/aiubpic3.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
